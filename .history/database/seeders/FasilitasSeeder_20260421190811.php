...
class FasilitasSeeder extends Seeder
{
    public function run()
    {
        // GANTI 'lapangan' menjadi nama tabel yang muncul di phpMyAdmin kamu
        // Berdasarkan error kamu, coba ganti jadi 'db_lapangan'
        DB::table('db_lapangan')->insert([
        ...
        // Cek juga nama tabel raket, apakah 'rakets' atau 'db_raket'?
