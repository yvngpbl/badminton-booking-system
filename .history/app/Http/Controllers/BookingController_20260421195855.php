...
class BookingController extends Controller
{
    ...
    public function booking(Request $request)
    {
        ...
        // --- PENYEMPURNAAN BARU: CARI DATA RAKET ---
        // Jika tidak sewa (0), biarkan jadi null. Jika sewa, cari ID aslinya.
        $idRaketAsli = null; 
        if ($hargaRaket > 0) {
            $raket = \App\Models\RaketModel::where('harga', $hargaRaket)->first();
            if ($raket) {
        ...
        try {
            ...
            \App\Models\BookingModel::create([
                ...
                'lapangan_id'  => $lapangan->id,     // Sudah aman (ID asli)
                'raket_id'     => $idRaketAsli,      // SEKARANG AMAN (Bisa null atau ID asli)
