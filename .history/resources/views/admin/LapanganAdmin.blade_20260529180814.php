...
<div class="min-h-screen bg-darkBg pt-10 pb-24 px-4 sm:px-6 lg:px-8 selection:bg-neon selection:text-black relative overflow-hidden">
    ...
    <img src="{{ asset('images/lapangan' . $loop->iteration . '.jpg') }}" alt="{{ $l->nama }}" class="w-full h-full object-cover grayscale group-hover:grayscale-0 group-hover:scale-105 transition duration-500">
