...
<div class="bg-darkBg min-h-screen font-sans selection:bg-neonLime selection:text-black">
    ...
    {{-- 1. HERO SECTION (Warna Putih Melengkung di Atas seperti gambar) --}}
    <div class="bg-white rounded-b-[3rem] md:rounded-b-[5rem] overflow-hidden relative px-6 pt-16 pb-32">
        <div class="max-w-7xl mx-auto text-center relative z-10">
            ...
            <div class="mt-8 flex justify-center gap-4">
                <a href="#fasilitas" class="bg-neonLime text-black px-8 py-4 rounded-full font-bold hover:bg-lime-400 transition shadow-[0_10px_40px_rgba(163,230,53,0.4)] flex items-center">
                    Lihat Fasilitas
                </a>
            </div>
        </div>
    ...
    {{-- 2. STATISTIK SECTION (Angka Neon di Background Gelap) --}}
    ...
    {{-- 3. TENTANG KAMI SECTION (Gaya "Turning Ideas into Masterpieces") --}}
